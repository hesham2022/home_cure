    ...
    return Padding(
      ...
      child: CustomScrollView(
        slivers: <Widget>[
          SliverToBoxAdapter(
            child: CommonHeader(
              title: widget.service.mainService,
            ),
          ),
          SliverGrid(
            ...
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                ...
                if (widget.service.children[index].title.split(' ').length >
                    2) {
...
// special case is elderly Care
                    ...
                    if (widget.service.children[index].children.isNotEmpty) {
                      context.router.push(
                        ServicesRoute(
                          service: widget.service.children[index],
                        ),
                      ...
                      if (widget.service.mainService == 'Our Doctors') {
                        context.router.push<void>(
                          const DoctorsRoute(),
                        );
                      } else {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Expanded(
                              child: widget
                                      .service.children[index].photo!.isNotEmpty
                                  ? SvgPicture.asset(
                                      widget.service.children[index].photo!,
                            ...
                            Text(
                              firstPartOfTitle,
                              style: TextStyle(
                                fontSize: widget.service.children.length > 2
                                    ? 12.sp
                                    : 17.sp,
                                color: const Color(0xff1AA9A0),
                              ),
          ...
          if (widget.service.mainService == 'Eldery Care')
            SliverToBoxAdapter(
              child: Column(
                children: [
                  SizedBox(
                  ...
                  return CommonContainer(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            widget.service.children[0].children[index].title,
                  ...
                  return CommonContainer(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            widget.service.children[1].children[index].title,
                            style: textStyleWithPrimaryBold.copyWith(
                              color: Colors.white,
                            ),
                          ),
