...
List<ServiceModel> getOurDoctors() {
  ...
  final s = [
    ...
    ServiceModel(
      ...
      role: 'doctor',
      ratingsAverage: 0,
      title: ar ? 'امراض الشيخوخه' : 'GERIATRICS',
      arTitle:'امراض الشيخوخه' ,
      photo: Assets.svg.geriatrics.path,
    ),
    ServiceModel(
      parent: '1',
