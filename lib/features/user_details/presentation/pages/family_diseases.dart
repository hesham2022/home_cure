...
class FamilyDeseasesPage extends StatefulWidget {
  const FamilyDeseasesPage({super.key});

  @override
  State<FamilyDeseasesPage> createState() => _FamilyDeseasesPageState();
}

class _FamilyDeseasesPageState extends State<FamilyDeseasesPage> {
  bool english = true;
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const CommonHeader(title: 'Family Deseases'),
            SizedBox(
              height: 30.h,
            ),
            Container(
