          ...
          children: [
            ...
            InfoButton(
              info: App.isAr(context)
                  ? (widget.service.arDescription ?? widget.service.description)
                    ...
                    children: [
                      ...
                      if (widget.service.numberOfSessions)
                        NumberOfSessionsWidget(
                          onChange: (v) {
                            setState(() {
                              customPrice = v * widget.service.price.toDouble();
                              customeDiscount = widget.service.priceDiscount ==
                                      null
                                  ? 0
                                  : v *
                                      widget.service.priceDiscount!.toDouble();
                              ...
                              onPressed: () {
                                ...
                                if (context
                                  ...
                                  showSimpleNotification(
                                    Text(
                                      context
                                          .l10n.pleaseSelectIfYouAllergicOrNot,
                                    ),
                                    background: Colors.red,
                                  );
                                  // ScaffoldMessenger.of(context)
                                ...
                                if (widget.service.priceDiscount != null &&
                                    ...
                                    widget.service.numberOfSessions == false) {
                                  context
                                      .read<AppointmentsParamsCubit>()
                                      .addDiscount(
