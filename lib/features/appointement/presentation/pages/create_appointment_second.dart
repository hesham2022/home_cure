                              ...
                              SizedBox(
                                ...
                                child: Theme(
                                  ...
                                  child: Checkbox(
                                    ...
                                    value: period == EveningMorning.evening,
                                    onChanged: (_) {
                                      setState(() {
                                        period = EveningMorning.evening;
                                      });
                                    },
                                  ),
                                ),
                              ...
                              SizedBox(
                                ...
                                child: Theme(
                                  ...
                                  child: Checkbox(
                                    ...
                                    value: period == EveningMorning.morning,
                                    onChanged: (_) {
                                      setState(() {
                                        period = EveningMorning.morning;
                                      });
                                    },
                                  ),
                                ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Button1(
                  onPressed: () {
                    print(widget.service.children);
                    if (widget.service.mainService == 'Eldery Care') {
                      if (first != null && last != null) {
                        var finalPrice = 0.0;
                        final days = last!.difference(first!).inDays;
                        final daysPackages =
                            widget.service.children.map((e) => e.days).toList();
                        if (daysPackages.contains(days)) {
                          finalPrice = widget.service.children
                              .firstWhere((element) => element.days == days)
                              .price!;
                        } else {
                          finalPrice = widget.service.children[0].price! * days;
                        }
                        context.router.push(
